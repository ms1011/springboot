...
public class ResolverController {
    ...
    /* 설명. 서블릿과 마찬가지로 포워딩을 통해 값을 전달할 수 있다 */
    @GetMapping("string")
    ...
    /* 설명. 서블릿과 마찬가지로 파라미터를 활용하지 않고서는 리다이렉트를 통해 값을 전달할 수 없다 (스프링은 해법이 있다) */
    ...
    /* 설명. 스프링의 RedirectAttritbutes라는 객체에 attr을 담으면 리다이렉트 시에도 값(전달할 상태)이 유지 된다 */
    ...
    /* 설명. 기존의 핸들러 메소드가 void 또는 String 으로만 반환했는데 ModelAndView를 반환하는 것도 가능하다 */
